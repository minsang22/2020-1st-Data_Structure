...
* - DisplayCurrent 함수 : current의 val을 출력해준다.
...
* description : DisplayCurrent의 사용 목적은 current가 가리키고 있는 노드의 값(val)을 출력해주기 위함이다.
*******************************************************************************************************************************/
...
int main(){
    ...
    while( num != 10 ){
        ...
        cout << "         (6)locateQurrent (7)updateCurrent (8)DisplayCurrent (9)displayList (10)quit" << endl;
        cout << "==>  ";
        cin >> num;
